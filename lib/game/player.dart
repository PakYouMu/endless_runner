...
class Player extends SpriteAnimationGroupComponent<PlayerAnimationStates>
    with CollisionCallbacks, HasGameReference<EndlessJungle> {
  ...
  // Player should never go. Basically the screen height - ground height
  double yMax = 0.0;

  // Player's current speed along y-axis.
  double speedY = 0.0;
